  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center  text-white">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-1 gap-8 text-center py-8 px-12 sm:px-0 text-gray-200">
          {techs.map(({ id, date, title, style,content }) => (
            ...
            >
                ...
                <p className="inline float-right px-4 mb-3 text-gray-400">{date}</p>
